...
const NPMS_MAX_RESULTS = 1200;                             // ± 5 pag., pas aan naar wens
const REGISTRY_PAGE_SIZE = 10;                            // lager = minder kans op 429
const REGISTRY_BACKOFF_MS = 12_000;                        // 12 s wachten bij 429
